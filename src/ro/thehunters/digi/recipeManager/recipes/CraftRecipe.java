...
public class CraftRecipe extends WorkbenchRecipe {
	 ...
	 * 
	 * @param ingredients
	 *            ingredients matrix, this also defines the shape, width and
	 *            height.
	 */
	 ...
	 * | 3 4 5 |<br>
	 * | 6 7 8 |</code> <br>
	 * Null slots are ignored and allow the recipe to be used in a smaller grid
	 * (inventory's 2x2 for example)<br>
	 * <br>
	 * <b>NOTE: always start with index 0 !</b> Then you can use whatever index
	 * you want up to 8.<br>
	 * This is required because ingredients are shifted to top-left corner of
	 * the 2D matrix on each call of this method.
	 * 
	 * @param slot
