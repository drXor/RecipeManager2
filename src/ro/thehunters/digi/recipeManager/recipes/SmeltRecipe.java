...
public class SmeltRecipe extends SingleResultRecipe {
	...
	/**
	 * @return min time or if hasRandomTime() gets a random between min and max
	 *         time.
	 */
	...
	public void resetName() {
		...
		/* TODO when furnace-data is pulled if(ingredient.getDurability() !=
		 * Vanilla.DATA_WILDCARD) {
	...
	public String printBook() {
		...
		/*if(isMultiResult()) {
		 * s.append('\n').append(Messages.RECIPEBOOK_MORERESULTS.get("{amount}",
		 * (getResults().size() - 1))); } */
