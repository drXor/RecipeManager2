...
public class Vanilla {
	...
	/**
	 * Leather dyeing's special recipe result, you can use it to identify
	 * vanilla recipes.
	 */
	public static final ItemStack RECIPE_LEATHERDYE = new ItemStack(Material.LEATHER_HELMET, 0, (short) 0);

	/**
	 * Map cloning's special recipe result, you can use it to identify vanilla
	 * recipes.
	 */
	public static final ItemStack RECIPE_MAPCLONE = new ItemStack(Material.MAP, 0, (short) -1);

	/**
	 * Map extending's special recipe result, you can use it to identify vanilla
	 * recipes.
	 */
	public static final ItemStack RECIPE_MAPEXTEND = new ItemStack(Material.EMPTY_MAP, 0, (short) 0);

	/**
	 * Fireworks' special recipe result, you can use it to identify vanilla
	 * recipes.
	 */
	...
	/**
	 * Removes a Bukkit recipe from the <b>server</b> <b>Note: This method
	 * converts the Bukkit recipe to RecipeManager recipe. If you have the
	 * BaseRecipe object you should use {@link #removeCustomRecipe(BaseRecipe)}
	 * </b>
	 * 
	 * @param recipe
	 *            Bukkit recipe
	 ...
	 * <b>Note: This method converts the Bukkit recipe to RecipeManager recipe.
	 * If you have the CraftRecipe object you should use
	 ...
	 * Removes a Bukkit recipe from the <b>server</b><br>
	 * <b>Note: This method converts the Bukkit recipe to RecipeManager recipe.
	 * If you have the CombineRecipe object you should use
	 ...
	 * Unlike {@link #removeShapedRecipe(ShapedRecipe)} and
	 * {@link #removeShapelessRecipe(ShapelessRecipe)} this method does not
	 * convert recipes since it only needs the ingredient.
	 * 
	 * @param recipe
	 *            Bukkit recipe
	 * @return removed recipe or null if not found
