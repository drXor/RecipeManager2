...
public class Recipes {
	...
	/**
	 * Checks if result is part of a recipe added by RecipeManager by checking
	 * item's lore.
	 * 
	 * @param result
	...
	/**
	 * Checks if recipe is added by RecipeManager, works for workbench and
	 * furnace recipes.<br>
	 * Does not work for fuels because they do not exist in Bukkit API, they're
	 * a custom system by RecipeManager.
	 * 
	 * @param recipe
	 *            must be the actual recipe, because it checks for result's
	 *            lore.
	 * @return
	 */
	...
	/**
	 * Checks if item can be used as a fuel. Alias for getFuelRecipe(item) !=
	 * null
	 * 
	 * @param item
	 * @return
	 ...
	 * If you know the specific type you can use
	 * {@link #getCraftRecipe(ItemStack)} or
	 * {@link #getCombineRecipe(ItemStack)}
	 * 
	 * @param recipe
	 * @return Workbench recipe, otherwise it can be null if doesn't exist or
	 *         you inputted a furnace recipe
	 */
	 ...
	 * The result must be the one from the bukkit recipe retrieved as it needs
	 * to check for result lore for the ID.<br>
	 * 
	 * @param result
	 ...
	 * You can use this on bukkit recipes by converting them to RecipeManager
	 * format using:<br>
	 ...
	 * Removing from this list does nothing, see {@link BaseRecipe #remove()}
	 * method instead.
	 * 
	 ...
	 * NOTE: You should not use this if you don't know what the recipe info
	 * object REALLY does.
	 * 
	 * @param recipe
	 * @param info
