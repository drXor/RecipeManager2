...
public class FlagCooldown extends Flag {
	...
	/**
	 * Gets the cooldown time in seconds for specified player or for global if
	 * null is specified and global is enabled.
	 * 
	 * @param playerName
	 *            if global is enabled this value is ignored, can be null.
	 * @return -1 if there is a problem otherwise 0 or more specifies seconds
	 *         left
	 */
	...
	/**
	 * Gets the cooldown time as formatted string for specified player or for
	 * global if null is specified and global is enabled.
	 * 
	 * @param playerName
	 *            if global is enabled this value is ignored, can be null.
	...
	/**
	 * Checks countdown time for player or globally if null is supplied and
	 * global is enabled.
	 * 
	 * @param playerName
	 *            if global is enabled this value is ignored, can be null.
	 ...
	 * ArrayList<String>(1);
	 * 
	 * list.add((global ? Messages.FLAG_COOLDOWN_SET_GLOBAL :
	 * Messages.FLAG_COOLDOWN_SET_PERPLAYER).get("{time}",
	 * timeToString(getCooldownTime())));
	 * 
	 * return list; } */
}
