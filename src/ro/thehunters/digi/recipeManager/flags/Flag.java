...
public class Flag implements Cloneable {
	 ...
	 * 
	 * @param value
	 *            the flag's value (not containing the <code>@flag</code>
	 *            string)
	 * @return
	...
	/**
	 * Apply the flag's effects - triggered when recipe is prepared or result is
	 * displayed
	 * 
	 * @param a
	 *            the arguments class for easily maintainable argument class
	 ...
	 * This also notifies the flag of removal, it might do some stuff before
	 * removal.<br>
	 * If the flag hasn't been added to any flag list, this method won't do
	 * anything.
	 */
	...
	/**
	 * Warning: this method doesn't check flag's values, it only compares flag
	 * type!
	 */
	@Override
	...
	/*/** Human friendly information about what the flag does with its current
	 * settings.
	 * 
	 * @return list of strings which represent individual lines or null if not
	 * defined. */
