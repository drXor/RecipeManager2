...
public enum FlagType {
	...
	private FlagType(Class<? extends Flag> flagClass, int bits,
			String... aliases) {
	...
	/**
	 * @return a new instance of the class asigned to this type or null if
	 *         failed and prints stack trace.
	 */
	 ...
	 * <br>
	 * It is used by the plugin to add the flags to an index map then create and
	 * add individual no-flag permissions.
	 */
	...
	public class Bit {
		...
		/**
		 * Disables flag from being stored - used on flags that directly affect
		 * result's metadata.
		 */
		...
		/**
		 * Disables shift+click on the recipe if there is at least one flag with
		 * this bit.
		 */
