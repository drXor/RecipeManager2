...
public class FlagCommand extends Flag {
	...
	/*@Override public List<String> information() { if(commands.isEmpty()) {
	 * return null; }
	 * 
	 * List<String> list = new ArrayList<String>(commands.size());
	 * 
	 * for(String command : commands) { if(command.charAt(0) == '/') {
	 * list.add(Messages.FLAG_COMMAND_PLAYER.get("{command}", command)); } else
