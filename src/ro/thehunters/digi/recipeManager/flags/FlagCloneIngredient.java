...
public class FlagCloneIngredient extends Flag {
	...
	/**
	 * Contains static constants that are usable in the 'copy' methods of
	 * {@link FlagCloneIngredient}.
	 */
	public class Bit {
	 ...
	 * 
	 * @return integer array of exacly 2 elements, first is the +/-/= char and
	 *         second is the data value
	 */
	...
	protected boolean onValidate() {
		 ...
		 * RecipeErrorReporter.error("Flag " + getType() +
		 * " only works on workbench (craft and combine) recipes!"); return
		 * false; } */
