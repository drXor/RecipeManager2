...
/**
 * Easily modifiable arguments for the flag classes without needing to re-edit
 * all of them
 * 
 * @author Digi
 */
public class Args {
	 ...
	 * For example, if you only set player name, the player() will still be
	 * null, but by triggering this it will try to asign player() to an Player
	 * object.
	 * 
