...
public interface Flaggable {
	 ...
	 * This is useful to check if {@link #getFlags()} would create a new Flags
	 * object when called.<br>
	 * 
	 * @return flags != null
	 */
	...
	/**
	 * @return true if flags prevent shift+click from creating more than one
	 *         item
	 */
