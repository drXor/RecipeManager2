...
public class Flags implements Cloneable {
	 ...
	 * Adds an error to the {@link ErrorReporter} class if flag is not
	 * compatible with recipe/result.
	 * 
	 * @param flag
	 */
	...
	/**
	 * Checks all flags and compiles a list of failure reasons while returning
	 * if the list is empty (no errors). Note: not all arguments are used, you
	 * may use null wherever you don't have anything to give.
	 * 
	 * @param a
	 *            arguments class
	 * @return true if recipe/result can be crafted by the arguments with the
	 *         current flags
	 */
	...
	/**
	 * Applies all flags to player/location/result and compiles a list of
	 * failure reasons while returning if the list is empty (no errors). Note:
	 * not all arguments are used, you may use null wherever you don't have
	 * anything to give.
	 * 
	 * @param a
	 *            arguments class
	 * @return false if something was absolutely required and crafting should be
	 *         cancelled
	 */
