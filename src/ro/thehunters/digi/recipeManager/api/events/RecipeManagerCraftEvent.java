...
/**
 * Event triggered before RecipeManager's custom recipes are crafted/combined in
 * the workbench.<br>
 ...
 * Event is triggered when a result is processed, it won't guarantee that the
 * player will get the result !
 * 
 * @author Digi
 */
public class RecipeManagerCraftEvent extends Event implements Cancellable {
	...
	public RecipeManagerCraftEvent(WorkbenchRecipe recipe, ItemResult result,
			Player player, ItemStack cursor, boolean shiftClick, int mouseButton) {
