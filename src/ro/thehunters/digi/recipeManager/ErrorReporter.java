 ...
 * Errors can be caught to be displayed in a single chunk along with file name
 * and lines.<br>
...
public class ErrorReporter {
	...
	/**
	 * Starts catching reported errors and stores them in a list for later
	 * printing.<br>
	 ...
	 * Calling this requires calling {@link #startCatching()} again to queue
	 * errors.
	 */
